...
- [x] 1.1 ナビゲーションフックを整備して一覧から詳細へ遷移できるようにする
...
- [x] 2. セッション詳細取得と状態管理のビューモデルを実装する
...
- [x] 3. セッション詳細ページのレイアウトとヘッダー情報を実装する
...
- [x] 3.2 暗号化 reasoning 用のプレースホルダーと告知 UI を実装する
...
- [x] 4.1 遅延ロードとスクロール端での読み込み制御を整備する
...
- [x] 5.1 仮想スクロールとパフォーマンスまわりの検証を追加する
